...
$label_read_less = get_field('read-less_label_read_less') ?? 'Read more';
...
<script>
    let labelReadMore = <?php echo json_encode($label_read_more); ?>;
    let labelReadLess = <?php echo json_encode($label_read_less); ?>;
    let heightReadMore = <?php echo json_encode((int) $height_collapsed); ?>;
</script>
